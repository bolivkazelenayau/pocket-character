...
fn discrete_menu_steps_match_one_keyboard_control_tick() {
    ...
    approx_eq(fov_decrement.fov_delta_deg, fov_step(-1));
    approx_eq(fov_increment.fov_delta_deg, fov_step(1));
    ...
    approx_eq(distance_decrement.distance_scale_delta, distance_step(-1));
    approx_eq(distance_increment.distance_scale_delta, distance_step(1));
}
